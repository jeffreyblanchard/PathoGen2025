...
neon.metaDB.my.soil <- neon.metaDB.my |> 
  ...
  separate(`dnaSampleID`, c("dnaSampleID.site","dnaSampleID"), "_") |> 
  
  mutate_at("dnaSampleID", str_replace, "-COMP", "_COMP") |>
  mutate_at("dnaSampleID", str_replace, "-GEN", "_GEN") |>
  separate(`dnaSampleID`, c("dnaSampleID","dnaSampleID.type"), "_") |> 
  
  mutate_at("dnaSampleID", str_replace, "-M", "_M") |>
  mutate_at("dnaSampleID", str_replace, "-O", "_O") |>
  separate(`dnaSampleID`, c("dnaSampleID.plot","dnaSampleID"), "_") |> 
  
  mutate_at("dnaSampleID", str_replace, "M-", "M_") |>
  mutate_at("dnaSampleID", str_replace, "O-", "O_") |>
  separate(`dnaSampleID`, c("dnaSampleID.layer","dnaSampleID"), "_") |> 

  mutate_at("dnaSampleID", str_replace, "-201", "201") |>
  mutate_at("dnaSampleID", str_replace, "-202", "202") |>
  mutate_at("dnaSampleID", str_replace, "201", "_201") |>
  mutate_at("dnaSampleID", str_replace, "202", "_202") |>
  separate(`dnaSampleID`, c("dnaSampleID.subplot","dnaSampleID.date"), "_") 
```
...
neon.metaDB.my.aquatic <- neon.metaDB.my |> 
  ...
  mutate_at("dnaSampleID", str_replace, ".DNA", "_DNA") |>
  separate(`dnaSampleID`, c("dnaSampleID","dnaSampleID.type"), "_") |> 
  
  separate(`dnaSampleID`, c("dnaSampleID.data","dnaSampleID.niche", "dnaSampleID.num"), "\\.") |> 
...
```
Trying to do the heatmap for all sites, but have trouble with the matrix including plots from all sites
