...
df_survey <- readr::read_csv("bio478_survey_responses.csv") |>
  clean_names() 
```
...
###  When AI was wrong, I typically… (multiple response checkboxes)
...
df <- read_csv("bio478_survey_responses.csv")
...
###  Common issues encountered (multiple response checkboxes)
...
# Choose whether percentages should be relative to respondents who answered this question ("answerers") or relative to all survey respondents ("all"):
percent_base <- "answerers" # "answerers" or "all"
csv_path <- "bio478_survey_responses.csv" # adjust path if needed
```
...
###  Where more support would help (multiple response checkboxes)
...
### Open response - Examples of helpful AI responses
...
### Open response - Examples of unhelpful or incorrect AI responses
...
### Open response - Suggested changes for future offering
...
### Open response - Final comments and suggestions
