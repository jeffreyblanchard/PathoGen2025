...
![](../images/labS3/version-graph.png)
...
![](../images/labS3/git-flowchart.png)
...
![](../images/labS3/select_branch.png)
...
![](../images/labS3/green_code_button.png)

### Make a local version of your github repo in Unity

* In `Your Home Directory click on File > New Project then `New Project from Git Repository`
...
![](../images/labS3/new_index_page.png)
...
Here is what the [example repo](https://github.com/jeffreyblanchard/pathogen-test) created above looks like.


## Linking an existing R project with a new Github repo (not intended for most people)
