...
We are using recently release National Ecological Observatory Network data to design a course-based Undergraduate Research Experience (CURE). The first 4 weeks we will discuss to project space, discuss research ideas and formulate testable hypothesis or discovery driven approaches, design the experimental approaches. For a preview today I will give an overview of the [project space](https://jeffreyblanchard.github.io/PathoGen2025/projects.html)
...
[Open OnDemand](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) makes supercomputing accessible through a web portal. 
