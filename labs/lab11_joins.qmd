...
Today in preparation for joining data frames with NEON data we will walk through [Chapter 19 Joins in R for Data Science](https://r4ds.hadley.nz/joins.html#sec-non-equi-joins). As we did earlier, by putting the examples and exercises in our own Quarto Markdown file, we can create own personal path through the Chapter. 
