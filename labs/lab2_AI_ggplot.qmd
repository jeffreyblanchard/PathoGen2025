...
* [American Society of Microbiology Guidelines for Authors Using AI Tools](https://journals.asm.org/generative-ai)
* [ChatGPT: guidelines for responsible use (Nature)](https://www.nature.com/articles/d41586-023-01853-w)
* [Guidelines from COPE](https://publicationethics.org/news-opinion)
* [ICMJE guidance](https://www.icmje.org/recommendations/browse/roles-and-responsibilities/defining-the-role-of-authors-and-contributors.html)
* [Webinar and article from STM integrity hub on use of generative AI in scholarly publishing](https://stm-assoc.org/events/stms-ethical-and-practical-guidelines-for-the-use-of-generative-ai-in-the-publication-process-webinar/)
* [CSR Review Matters Blog (nih.gov)](https://www.csr.nih.gov/reviewmatters/2023/06/23/using-ai-in-peer-review-is-a-breach-of-confidentiality/)
...
Working through the exercises is a great time to explore changing the code with or without Copilot! Answers to all the questions are available online thanks to [Martin Lukic](https://github.com/martin-lukic/r4ds-2e-exercise-solutions) and others. I recommend not using these, but learn how to use Copilot to help when your are not sure and to ask me questions during class, help sessions or email.
